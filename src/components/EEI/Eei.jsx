...
import EngagementItemModal from "../EngagementStuff/EngagementItemModal/EngagementItemModal";
// import "./EngagementItem.css";

export default function Eei(props) {
      ...
      >
        <Modal.Body>
          <EngagementItemModal
            ...
            videoOne={props.videoOne}
            videoTwo={props.videoTwo}
            videoThree={props.videoThree}
          />
        </Modal.Body>
      </Modal>
    </div>
